...
export class GToken__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class GToken extends ethereum.SmartContract {
  ...
  getAssetPrice(): BigInt {
    let result = super.call("getAssetPrice", "getAssetPrice():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getAssetPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getAssetPrice",
      "getAssetPrice():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getScaledUserBalanceAndSupply(
    user: Address,
  ): GToken__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new GToken__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address,
  ): ethereum.CallResult<GToken__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)],
    ...
    return ethereum.CallResult.fromValue(
      new GToken__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  mint(user: Address, amount: BigInt, index: BigInt): boolean {
  ...
  transferUnderlyingTo(target: Address, amount: BigInt): BigInt {
    let result = super.call(
      "transferUnderlyingTo",
      "transferUnderlyingTo(address,uint256):(uint256)",
      [
