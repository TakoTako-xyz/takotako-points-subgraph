...
export class LendingPool__getReserveDataResultValue0Struct extends ethereum.Tuple {
  get configuration(): LendingPool__getReserveDataResultValue0ConfigurationStruct {
    return changetype<LendingPool__getReserveDataResultValue0ConfigurationStruct>(
      this[0].toTuple(),
    );
  }
...
export class LendingPool__getUserAccountDataResult {
  ...
  getTotalCollateralETH(): BigInt {
    return this.value0;
  }

  getTotalDebtETH(): BigInt {
    return this.value1;
  }

  getAvailableBorrowsETH(): BigInt {
    return this.value2;
  }
